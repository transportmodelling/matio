...
Type
  ...
  private
    ...
    FH5Aexists_by_name: Function(ObjId: Int64; obj_name: PAnsiChar; attr_name: PAnsiChar; lapl_id: Int64): Integer; cdecl;
  ...
  public
    ...
    Function H5Aexists_by_name(ObjId: Int64; obj_name,attr_name: AnsiString; lapl_id: Int64): Boolean;
...
begin
  ...
  begin
    ...
    FH5Aexists_by_name := GetDllMethod('H5Aexists_by_name');
...
Function THdf5Dll.H5Aexists_by_name(ObjId: Int64; obj_name,attr_name: AnsiString; lapl_id: Int64): Boolean;
begin
  var Exists := FH5Aexists_by_name(ObjId,PAnsiChar(obj_name),PAnsiChar(attr_name),lapl_id);
  if Exists < 0 then raise Exception.Create('Error calling H5Aexists_by_name');
  Result := Exists > 0;
end;
...
begin
  ...
  // Truncate at the null terminator of null-terminated strings; the ensured
  // final terminator keeps strings intact that fill their entire storage size
  AttributeValue[AttributeSize+1] := #0;
  AttributeValue := AnsiString(pAnsiChar(AttributeValue));
  H5Aclose(AttributeId);
  H5Tclose(TypeId);
  H5Sclose(SpaceId);
end;
